...
[https://www.linkedin.com/in/akshay-lakwal](https://www.linkedin.com/in/akshay-lakwal)· [lakwalakshay41@gmail.com](mailto:lakwalakshay41@gmail.com)
...
**[Prescripto](https://github.com/akash4550/Prescripto)** — Healthcare appointment booking with three portals (patient, doctor, admin) on one shared backend. Doctor availability is tracked per-slot with conflict checks on booking, and payments run through Razorpay. Live: [patient portal](https://prescriipto.netlify.app), [admin dashboard](https://prescriptionadmin.netlify.app), [doctor dashbord](https://prescriptionadmin.netlify.app).
